...
private:
  ...
  const int tangramPieces = 3;

  void createMesh(int currentPiece, std::string mesh_file);
  void createMeshes();
  void createShaderPrograms(int currentPiece);
...
void MyApp::createMesh(int currentPiece, std::string mesh_file) {
...
void MyApp::createShaderPrograms(int currentPiece) {
  ...
  sceneGraph[currentPiece].shader = Shaders;
}
...
void MyApp::scrollCallback(GLFWwindow* window, double xoffset, double yoffset) {
	...
	cameraManager->updateCameraRadius(scrollDelta);
}

void MyApp::createAllShaderPrograms() {
    for (int i = 0; i < tangramPieces; i++) {
        createShaderPrograms(i);
    }
}
///////////////////////////////////////////////////////////////////////// CAMERA
