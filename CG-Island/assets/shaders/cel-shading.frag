...
uniform sampler2D normalMap; // this is not used currently but I gave it a try with the sand

uniform bool useTexture;
uniform vec3 colorUniform;
uniform float glossiness;

const vec3 lightPos = vec3(+10.0f, 7.0f, +10.0f);
...
void main(void)
{
    ...
    light = lightColor * intensity * 0.9; // 0.9 is just an experimental number to make the light less bright
